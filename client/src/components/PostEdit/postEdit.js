...
const PostEdit = ({ symbol, cancel }) => {
  ...
  const validation = () => {
    ...
    !tickerInvalid.invalid && !titleInvalid.invalid && !bodyInvalid.invalid
      ? (r = true)
      : (r = false);
      ...
      <Card.Body>
        ...
        <Form.Group>
          ...
          <Form.Control
            as="input"
            onChange={(e) =>
              dispatchInfo({ value: e.target.value, field: "title" })
            }
          />
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            rows={6}
            onChange={(e) =>
              dispatchInfo({ value: e.target.value, field: "body" })
            }
          />
